...
<div class="wp-block-cp-codepen-gutenberg-embed-block cp_embed_wrapper resizable" style="height: 450px;"><iframe id="cp_embed_wvaorrM" src="//codepen.io/anon/embed/wvaorrM?height=450&amp;theme-id=1&amp;slug-hash=wvaorrM&amp;default-tab=result" height="450" scrolling="no" frameborder="0" allowfullscreen="" allowpaymentrequest="" name="CodePen Embed wvaorrM" title="CodePen Embed wvaorrM" class="cp_embed_iframe" style="width: 100%; overflow: hidden; height: 100%;">CodePen Embed Fallback</iframe><div class="win-size-grip" style="touch-action: none;"></div></div>

제 "여기에 아무도 없지만 우리 인간은 ... 2"펜에서 반대의 일이 발생합니다.
 

<div class="wp-block-cp-codepen-gutenberg-embed-block cp_embed_wrapper resizable" style="height: 450px;"><iframe id="cp_embed_BajxGwg" src="//codepen.io/anon/embed/BajxGwg?height=450&amp;theme-id=1&amp;slug-hash=BajxGwg&amp;default-tab=result" height="450" scrolling="no" frameborder="0" allowfullscreen="" allowpaymentrequest="" name="CodePen Embed BajxGwg" title="CodePen Embed BajxGwg" class="cp_embed_iframe" style="width: 100%; overflow: hidden; height: 100%;">CodePen Embed Fallback</iframe><div class="win-size-grip" style="touch-action: none;"></div></div>

웹 사이트를 3D 공간으로 생각하면 이전에는 고려하지 않았던 가능성을 열 수 있습니다.
 브라우저에서 바로 작동하는 3D 변환이 있지만 이것이 제가 말하는 유일한 것은 아닙니다.
 음영, 그림자, 상대적 크기, 흐림 또는 기타 유형의 왜곡을 사용하여 3D 효과를 "위조"하는 방법에는 여러 가지가 있습니다.
 

예를 들어, "마지막으로, 샌드위치와 함께 ..."펜에서 다차원 공간을 모방하기 위해 쌓기 순서를 사용했습니다.
 사람의 머리 회전이 효과에 대한 신뢰도를 높이는 방법을 확인하세요.
...
### 장면으로 애니메이션을 한 단계 업그레이드
 

내가 가장 자랑스러워하는 작업 중 일부는 바보 같은 캐릭터를 뛰어 넘어 바보 같은 일을하는 것입니다 (그것도 자랑 스럽지만).
 특히 떠오르는 두 가지 애니메이션이 있습니다.
 

첫 번째는 제가 "좀비 눈 2"라고 부르는 것입니다.
 

<div class="wp-block-cp-codepen-gutenberg-embed-block cp_embed_wrapper resizable" style="height: 700px;"><iframe id="cp_embed_ZEQLxOe" src="//codepen.io/anon/embed/ZEQLxOe?height=700&amp;theme-id=1&amp;slug-hash=ZEQLxOe&amp;default-tab=result" height="700" scrolling="no" frameborder="0" allowfullscreen="" allowpaymentrequest="" name="CodePen Embed ZEQLxOe" title="CodePen Embed ZEQLxOe" class="cp_embed_iframe" style="width: 100%; overflow: hidden; height: 100%;">CodePen Embed Fallback</iframe><div class="win-size-grip" style="touch-action: none;"></div></div>

이것이 나에게 눈에 띄는 이유는 카메라가 갑자기 (그리고 예상치 못한 플롯 왜곡으로) 시청자를 스토리의 캐릭터로 바꾸는 방법입니다.
 좀비의 샷이 발사되면 카메라가 롤오버되어 본질적으로 샷을받은 사람이 본인임을 나타냅니다.
 

두 번째로 떠오르는 작품은“Lunch (at) Noon”입니다.
 

<div class="wp-block-cp-codepen-gutenberg-embed-block cp_embed_wrapper resizable" style="height: 750px;"><iframe id="cp_embed_LYGxGvZ" src="//codepen.io/anon/embed/LYGxGvZ?height=750&amp;theme-id=1&amp;slug-hash=LYGxGvZ&amp;default-tab=result" height="750" scrolling="no" frameborder="0" allowfullscreen="" allowpaymentrequest="" name="CodePen Embed LYGxGvZ" title="CodePen Embed LYGxGvZ" class="cp_embed_iframe" style="width: 100%; overflow: hidden; height: 100%;">CodePen Embed Fallback</iframe><div class="win-size-grip" style="touch-action: none;"></div></div>

(좀비의 머리에서 모자를 쏘는 중학교의 기쁨을 느꼈던 것 같습니다. * 어깨를 으쓱 * 쉽게 즐겁게 즐기는 것은 값싼 오락입니다.)
